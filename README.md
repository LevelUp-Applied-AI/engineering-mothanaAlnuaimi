...
I use a **notebook** when I’m exploring data interactively, iterating quickly, and I want code, notes, and outputs shown together. I use a **script** when I need a repeatable top-to-bottom run, cleaner version control diffs, and code that can be reused or tested more easily.
...
3. Run a quick sanity check (from the repo root):
   - `python scripts/sanity.py`

4. Confirm success:
   - The sanity script should complete without errors.
